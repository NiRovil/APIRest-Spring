package br.com.descomplica.controller;
...
import br.com.descomplica.service.ProdutoService;
...
public class ProdutoController {
	...
	@PostMapping
	public ResponseEntity<Produto> savePedido(@RequestBody Produto produto){
		return new ResponseEntity<>(produtoService.saveProduto(produto), HttpStatus.OK);
	}
	
	@PutMapping("/{id}")
	public ResponseEntity<Produto> updatePedido(@PathVariable Integer id, @RequestBody Produto produto) {
